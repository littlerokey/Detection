...
def main():
    imgs_dir ='D:\\work\\xm\\detection\\KK\\JPEGImages\\'
    bk_imgs_dir ='D:\\work\\xm\\detection\\MB\\bk\\'
    xmls_dir = 'D:\\work\\xm\\detection\\KK\\Annotation\\'
    
    imgs_save_dir= 'D:\\work\\xm\\detection\\KK\\rimgs\\'
    if not os.path.exists(imgs_save_dir):
        os.makedirs(imgs_save_dir)
    xmls_save_dir='D:\\work\\xm\\detection\\KK\\rxml\\'
...
#                        {'opt':'resize','fx':0.5,'fy':0.5,'dsize':(0,0),'imgwh':[]}]  
    ...
    transforms = [     {'opt':'rotate','cterxy':[],'imgwh':[],'rot_angle':0,'randomRotation':True,\
                        ...
                        {'opt':'flip','flip_type':-1,'random_flip':True,'imgwh':[]},
                        {'opt':'resize','fx':0.8,'fy':0.8,'dsize':(part_imgw,part_imgh),'imgwh':[]}] 
