...
def main():
    imgs_xmls_dirs = {0:{'imgs_dir':'D:\\work\\xm\\detection\\MB\\JPEGImages\\',\
                    'bk_imgs_dir':'D:\\work\\xm\\detection\\MB\\resize_img\\',\
                    'xmls_dir':'D:\\work\\xm\\detection\\MB\\Annotation\\'},
                        
                     }
    
    imgs_save_dir = 'D:\\work\\xm\\detection\\MB\\rotate_img\\'
    if not os.path.exists(imgs_save_dir):
        os.makedirs(imgs_save_dir)
    xmls_save_dir ='D:\\work\\xm\\detection\\MB\\rotate_xml\\'
    if not os.path.exists(xmls_save_dir):
        os.makedirs(xmls_save_dir)
        
    N = 5
    
    transforms = [{'opt':'resize','fx':0.8,'fy':0.8,'dsize':(1536,864),'imgwh':[]},  
                      {'opt':'rotate','cterxy':[],'imgwh':[],'rot_angle':0,'randomRotation':True,\
                       ...
                       {'opt':'flip','flip_type':-1,'random_flip':True,'imgwh':[]},
                        {'opt':'crop','crop_type':'RANDOM_CROP','dsize':(400,300),'top_left_x':0,'top_left_y':0,\
